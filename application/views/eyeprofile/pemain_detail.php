...
$pemain=$this->db->query("SELECT a.*,b.name as club_name,b.competition,b.logo FROM tbl_player a INNER JOIN tbl_club b ON b.club_id=a.club_id WHERE player_id='".$pid."' LIMIT 1")->row_array();
?>
<style>
img {
    cursor: pointer;
...
<div class="text-center">
	<a href="<?=base_url()?>eyeprofile/klub_detail/<?=$pemain["club_id"]?>" class="btn btn-primary" style="line-height: 40px;">
...
<div id="line1">Nama Klub<small id="set5"><b><a href="<?=base_url()?>eyeprofile/klub_detail/<?=$pemain["club_id"]?>"><?=$pemain["club_name"]?></a></b></small></div>
